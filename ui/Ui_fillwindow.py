...
class Ui_fillWindow(object):
    def setupUi(self, fillWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(self.progPath + "/icons/warning_icon2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.fw_label_2.setPixmap(QtGui.QPixmap(_fromUtf8(self.progPath + "/icons/warning_icon2.png")))
