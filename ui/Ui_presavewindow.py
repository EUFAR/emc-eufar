...
class Ui_presaveWindow(object):
    def setupUi(self, presaveWindow):
        ...
        self.iw_label_2.setPixmap(QtGui.QPixmap(_fromUtf8("icons/warning_icon2.png")))
        ...
        self.iw_saveButton.setMinimumSize(QtCore.QSize(100, 27))
        self.iw_saveButton.setMaximumSize(QtCore.QSize(100, 27))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("font/DroidSansFallbackFull.ttf"))
        font.setPointSize(10)
        font.setBold(False)
